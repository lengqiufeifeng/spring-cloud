...
public abstract class  MyAbstractMultipartForm {
     ...
     */
    public MyAbstractMultipartForm(final Charset charset, final String boundary) {
        super();
    ...
    public MyAbstractMultipartForm(final String boundary) {
        this(null, boundary);
    }
